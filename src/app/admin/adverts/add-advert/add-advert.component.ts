...
export class AddAdvertComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private advertHttpService: AdvertHttpService,
              private modelHttpService: ModelHttpService, private skateshopHttpService: SkateshopHttpService, private router: Router) { }
